---
title: >-
  CheckoutAndAccountsConfigurationBrandingSecondaryButtonColorRoles - GraphQL
  Admin
description: The secondary button color customizations.
api_version: 2026-07
source_url:
  html: >-
    https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutAndAccountsConfigurationBrandingSecondaryButtonColorRoles
  md: >-
    https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutAndAccountsConfigurationBrandingSecondaryButtonColorRoles.md
api_name: admin
api_type: graphql
type: object
metadata:
...
# Checkout​And​Accounts​Configuration​Branding​Secondary​Button​Color​Roles
...
* [CheckoutAndAccountsConfigurationBrandingColors.secondaryButton](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutAndAccountsConfigurationBrandingColors#field-CheckoutAndAccountsConfigurationBrandingColors.fields.secondaryButton)
