---
title: CheckoutAndAccountsConfigurationBrandingTextField - GraphQL Admin
description: The text fields customizations.
api_version: 2026-07
source_url:
  html: >-
    https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutAndAccountsConfigurationBrandingTextField
  md: >-
    https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutAndAccountsConfigurationBrandingTextField.md
api_name: admin
api_type: graphql
type: object
metadata:
...
# Checkout​And​Accounts​Configuration​Branding​Text​Field
...
* [CheckoutAndAccountsConfigurationBrandingComponents.textField](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutAndAccountsConfigurationBrandingComponents#field-CheckoutAndAccountsConfigurationBrandingComponents.fields.textField)
