---
title: channelByHandle - GraphQL Admin
description: >-
  Returns a
  [`Channel`](https://shopify.dev/docs/api/admin-graphql/latest/objects/Channel)

  by its unique string handle. The handle is either set explicitly during
...
api_version: 2026-07
source_url:
  html: 'https://shopify.dev/docs/api/admin-graphql/latest/queries/channelByHandle'
  md: 'https://shopify.dev/docs/api/admin-graphql/latest/queries/channelByHandle.md'
api_name: admin
api_type: graphql
type: query
metadata:
