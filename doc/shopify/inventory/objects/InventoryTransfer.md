...
api_version: 2026-07
source_url:
  html: 'https://shopify.dev/docs/api/admin-graphql/latest/objects/InventoryTransfer'
  md: >-
    https://shopify.dev/docs/api/admin-graphql/latest/objects/InventoryTransfer.md
api_name: admin
api_type: graphql
type: object
metadata:
...
* [InventoryTransferConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/InventoryTransferConnection#returns-nodes)
* [InventoryTransferEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/InventoryTransferEdge#field-InventoryTransferEdge.fields.node)
