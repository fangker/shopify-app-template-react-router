...
api_version: 2026-07
source_url:
  html: 'https://shopify.dev/docs/api/admin-graphql/latest/queries/metaobject'
  md: 'https://shopify.dev/docs/api/admin-graphql/latest/queries/metaobject.md'
api_name: admin
api_type: graphql
type: query
metadata:
...
* ### Fetch a metaobject by ID
  ...
  Retrieves a metaobject by its global ID.
  ...
  ```json
  {
    "id": "gid://shopify/Metaobject/971662587"
  }
  ```
  ...
  -d '{
  "query": "query Metaobject($id: ID!) { metaobject(id: $id) { id handle type displayName values } }",
   "variables": {
      "id": "gid://shopify/Metaobject/971662587"
    }
  }'
...
* ### Fetch a metaobject's fields with type and references

  #### Description

  Use \`fields\` when you need per-field type information, the field definition, or paginated references.
  ...
  ```json
  {
    "id": "gid://shopify/Metaobject/971662586"
  }
  ```
  ...
  -H 'X-Shopify-Access-Token: {access_token}' \
  -d '{
  "query": "query Metaobject($id: ID!) { metaobject(id: $id) { id handle fields { key value jsonValue definition { key type { name } } references(first: 5) { nodes { __typename } } } } }",
   "variables": {
      "id": "gid://shopify/Metaobject/971662586"
    }
  }'
...
* ### Fetch metaobject with publish status
  ...
  ```json
  {
    "id": "gid://shopify/Metaobject/971662588"
  }
  ```
  ...
  -H 'X-Shopify-Access-Token: {access_token}' \
  -d '{
  "query": "query Metaobject($id: ID!) { metaobject(id: $id) { id handle displayName capabilities { publishable { status } } values } }",
   "variables": {
      "id": "gid://shopify/Metaobject/971662588"
    }
  }'
