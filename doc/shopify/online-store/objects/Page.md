...
description: >-
  ...
  suffixes for specialized layouts. Pages can be published or hidden, and
  include

  creation and update timestamps.
api_version: 2026-07
source_url:
  html: 'https://shopify.dev/docs/api/admin-graphql/latest/objects/Page'
  md: 'https://shopify.dev/docs/api/admin-graphql/latest/objects/Page.md'
api_name: admin
api_type: graphql
type: object
metadata:
...
* [PageConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/PageConnection#returns-nodes)
* [PageEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/PageEdge#field-PageEdge.fields.node)
