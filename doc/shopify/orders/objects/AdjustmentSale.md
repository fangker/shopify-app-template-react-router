...
api_version: 2026-07
source_url:
  html: 'https://shopify.dev/docs/api/admin-graphql/latest/objects/AdjustmentSale'
  md: 'https://shopify.dev/docs/api/admin-graphql/latest/objects/AdjustmentSale.md'
api_name: admin
api_type: graphql
type: object
metadata:
