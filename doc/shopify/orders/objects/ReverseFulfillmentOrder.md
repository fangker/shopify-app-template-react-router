...
source_url:
  html: >-
    https://shopify.dev/docs/api/admin-graphql/latest/objects/ReverseFulfillmentOrder
  md: >-
    https://shopify.dev/docs/api/admin-graphql/latest/objects/ReverseFulfillmentOrder.md
api_name: admin
api_type: graphql
type: object
metadata:
...
* [ReverseDelivery.reverseFulfillmentOrder](https://shopify.dev/docs/api/admin-graphql/latest/objects/ReverseDelivery#field-ReverseDelivery.fields.reverseFulfillmentOrder)
* [ReverseFulfillmentOrderConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/ReverseFulfillmentOrderConnection#returns-nodes)
* [ReverseFulfillmentOrderEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/ReverseFulfillmentOrderEdge#field-ReverseFulfillmentOrderEdge.fields.node)
