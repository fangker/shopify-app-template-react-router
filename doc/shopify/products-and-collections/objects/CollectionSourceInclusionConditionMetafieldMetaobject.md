---
title: CollectionSourceInclusionConditionMetafieldMetaobject - GraphQL Admin
description: >-
  A condition based on single metaobject reference metafield values for
  including products in a collection.
api_version: 2026-07
source_url:
  html: >-
    https://shopify.dev/docs/api/admin-graphql/latest/objects/CollectionSourceInclusionConditionMetafieldMetaobject
  md: >-
    https://shopify.dev/docs/api/admin-graphql/latest/objects/CollectionSourceInclusionConditionMetafieldMetaobject.md
api_name: admin
api_type: graphql
type: object
metadata:
...
# Collection​Source​Inclusion​Condition​Metafield​Metaobject
...
* relation
  ...
  [Collection​Source​Inclusion​Condition​Metafield​Metaobject​Relation!](https://shopify.dev/docs/api/admin-graphql/latest/enums/CollectionSourceInclusionConditionMetafieldMetaobjectRelation)
...
## CollectionSourceInclusionConditionMetafieldMetaobject Implements
