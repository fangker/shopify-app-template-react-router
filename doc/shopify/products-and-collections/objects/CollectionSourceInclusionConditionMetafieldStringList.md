---
title: CollectionSourceInclusionConditionMetafieldStringList - GraphQL Admin
description: >-
  A condition based on list of string metafield values for including products in
  a collection.
api_version: 2026-07
source_url:
  html: >-
    https://shopify.dev/docs/api/admin-graphql/latest/objects/CollectionSourceInclusionConditionMetafieldStringList
  md: >-
    https://shopify.dev/docs/api/admin-graphql/latest/objects/CollectionSourceInclusionConditionMetafieldStringList.md
api_name: admin
api_type: graphql
type: object
metadata:
...
# Collection​Source​Inclusion​Condition​Metafield​String​List
...
* relation
  ...
  [Collection​Source​Inclusion​Condition​Metafield​String​List​Relation!](https://shopify.dev/docs/api/admin-graphql/latest/enums/CollectionSourceInclusionConditionMetafieldStringListRelation)
...
## CollectionSourceInclusionConditionMetafieldStringList Implements
