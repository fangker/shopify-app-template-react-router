---
title: DeliveryCarrierCalculatedOptionDefinition - GraphQL Admin
description: >-
  A shipping option with rates calculated by a carrier service.


  Carrier-calculated options fetch real-time rates from carriers(e.g., UPS,
  FedEx) at checkout
...
source_url:
  html: >-
    https://shopify.dev/docs/api/admin-graphql/latest/objects/DeliveryCarrierCalculatedOptionDefinition
  md: >-
    https://shopify.dev/docs/api/admin-graphql/latest/objects/DeliveryCarrierCalculatedOptionDefinition.md
api_name: admin
api_type: graphql
type: object
metadata:
...
* rate​Groups
  ...
  [Delivery​Carrier​Calculated​Rate​Group​Connection](https://shopify.dev/docs/api/admin-graphql/latest/connections/DeliveryCarrierCalculatedRateGroupConnection)
...
## DeliveryCarrierCalculatedOptionDefinition Implements
