...
source_url:
  ...
  md: >-
    https://shopify.dev/docs/api/admin-graphql/latest/objects/FulfillmentTrackingInfo.md
api_name: admin
api_type: graphql
type: object
metadata:
...
* [Fulfillment.trackingInfo](https://shopify.dev/docs/api/admin-graphql/latest/objects/Fulfillment#field-Fulfillment.fields.trackingInfo)
* [ShippingLabel.trackingInfo](https://shopify.dev/docs/api/admin-graphql/latest/objects/ShippingLabel#field-ShippingLabel.fields.trackingInfo)
