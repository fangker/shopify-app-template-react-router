...
description: Returns a `DeliveryCarrierService` resource by ID.
api_version: 2026-07
source_url:
  html: 'https://shopify.dev/docs/api/admin-graphql/latest/queries/carrierService'
  md: 'https://shopify.dev/docs/api/admin-graphql/latest/queries/carrierService.md'
api_name: admin
api_type: graphql
type: query
metadata:
