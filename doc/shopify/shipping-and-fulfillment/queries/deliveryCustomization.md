...
source_url:
  html: >-
    https://shopify.dev/docs/api/admin-graphql/latest/queries/deliveryCustomization
  md: >-
    https://shopify.dev/docs/api/admin-graphql/latest/queries/deliveryCustomization.md
api_name: admin
api_type: graphql
type: query
metadata:
